...
pub unsafe extern "C" fn cass_data_type_new(
    ...
    let inner = match value_type {
        ...
        CassValueType::CASS_VALUE_TYPE_UNKNOWN => return CassConstPtr::null(),
...
#[no_mangle]
pub unsafe extern "C" fn cass_data_type_new_udt(field_count: size_t) -> CassConstPtr<CassDataType> {
...
#[no_mangle]
pub unsafe extern "C" fn cass_data_type_free(data_type: CassConstPtr<CassDataType>) {
...
// #[no_mangle]
// pub unsafe extern "C" fn cass_data_type_is_frozen(data_type: CassConstPtr<CassDataType>) -> cass_bool_t {}
...
pub unsafe extern "C" fn cass_data_type_set_type_name_n(
    data_type_raw: CassConstPtr<CassDataType>,
    type_name: *const c_char,
...
#[no_mangle]
pub unsafe extern "C" fn cass_data_sub_type_count(data_type: CassConstPtr<CassDataType>) -> size_t {
...
pub unsafe extern "C" fn cass_data_type_add_sub_type(
    data_type: CassConstPtr<CassDataType>,
    sub_data_type: CassConstPtr<CassDataType>,
) -> CassError {
    let data_type = ArcFFI::as_ref(data_type).unwrap();
    match data_type
        .get_mut_unchecked()
...
pub unsafe extern "C" fn cass_data_type_add_sub_type_by_name_n(
    ...
    name: *const c_char,
    name_length: size_t,
    sub_data_type_raw: CassConstPtr<CassDataType>,
) -> CassError {
